...
public class Database {
    ...
    public void addRanking_result(RankingResult ranking_result) throws SQLException {
    try {
            Statement st = connection.createStatement();
    ...
    public void addRanking_raw_info_result(RankingRawInfoResult raw_info) throws SQLException {
        try {
            Statement st = connection.createStatement();
            ResultSet rs = st.executeQuery("SELECT id FROM faculty");
            int id = 0;
    ...
    public void addRanking_method(RankingMethod rank) throws SQLException {
        try {
            Statement st = connection.createStatement();
    ...
    public void addRanking_raw_info_description(RankingRawInfoDescription rank) throws SQLException {
        try {
            Statement st = connection.createStatement();
    ...
    public void addSpeciality_faculty(SpecialityFaculty spec_fac) throws SQLException {
        try {
